...
%     try
%         disp('LAMB')
%         EEGO = pop_epoch( EEG, { 'DLam' }, [0  8], 'newname', 'EGI file epochs', 'epochinfo', 'yes');
...
%     try
%         disp('Simpl')
%         EEGD = pop_epoch( EEG, { 'DSim' }, [0  8], 'newname', 'EGI file epochs', 'epochinfo', 'yes');
%         % [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, CURRENTSET,'setname', 'EGI file epochs', 'save', setNamesegNx);
...
%     try
%         disp('Marry')
%         EEGS = pop_epoch( EEG, { 'DMar' }, [0  8], 'newname', 'EGI file epochs', 'epochinfo', 'yes');
%         % [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, CURRENTSET,'setname', 'EGI file epochs', 'save', setNamesegNx);
...
%     try
%         disp('Frere')
%         EEGR = pop_epoch( EEG, { 'DFre' }, [0  8], 'newname', 'EGI file epochs', 'epochinfo', 'yes');
%         % [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, CURRENTSET,'setname', 'EGI file epochs', 'save', setNamesegNx);
...
%     try
%         dips('Twin')
%         EEGO = pop_epoch( EEG, { 'DTwi' }, [0  8], 'newname', 'EGI file epochs', 'epochinfo', 'yes');
%         % [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, CURRENTSET,'setname', 'EGI file epochs', 'save', setNamesegNx);
%         EEGO = pop_rmbase( EEGO, [0  8000]);
%         EEGO = pop_saveset( EEGO, NamSetSongOne, pathOut);
%         
...
%     try
%         disp('Jajill')
%         EEGO = pop_epoch( EEG, { 'DJaJ' }, [0  8], 'newname', 'EGI file epochs', 'epochinfo', 'yes');
%         % [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, CURRENTSET,'setname', 'EGI file epochs', 'save', setNamesegNx);
%         EEGO = pop_rmbase( EEGO, [0  8000]);
%         EEGO = pop_saveset( EEGO, NamSetSongOne, pathOut);
%         
...
%     try
%         disp('Hicko')
%         EEGO = pop_epoch( EEG, { 'DHic' }, [0  8], 'newname', 'EGI file epochs', 'epochinfo', 'yes');
%         % [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, CURRENTSET,'setname', 'EGI file epochs', 'save', setNamesegNx);
%         EEGO = pop_rmbase( EEGO, [0  8000]);
%         EEGO = pop_saveset( EEGO, NamSetSongOne, pathOut);
%         
...
%     try
%         disp('Ring')
%         EEGO = pop_epoch( EEG, { 'DRin' }, [0  8], 'newname', 'EGI file epochs', 'epochinfo', 'yes');
%         % [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, CURRENTSET,'setname', 'EGI file epochs', 'save', setNamesegNx);
%         EEGO = pop_rmbase( EEGO, [0  8000]);
%         EEGO = pop_saveset( EEGO, NamSetSongOne, pathOut);
%         
...
%     try
%         disp('Muff')
%         EEGO = pop_epoch( EEG, { 'DMuf' }, [0  8], 'newname', 'EGI file epochs', 'epochinfo', 'yes');
%         % [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, CURRENTSET,'setname', 'EGI file epochs', 'save', setNamesegNx);
%         EEGO = pop_rmbase( EEGO, [0  8000]);
%         EEGO = pop_saveset( EEGO, NamSetSongOne, pathOut);
%         
...
%     try
%         disp('Muff')
%         EEGO = pop_epoch( EEG, { 'DWhe' }, [0  8], 'newname', 'EGI file epochs', 'epochinfo', 'yes');
%         % [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, CURRENTSET,'setname', 'EGI file epochs', 'save', setNamesegNx);
%         EEGO = pop_rmbase( EEGO, [0  8000]);
%         EEGO = pop_saveset( EEGO, NamSetSongOne, pathOut);
%         
...
%     try
%         disp('Incy')
%         EEGO = pop_epoch( EEG, { 'DInc' }, [0  8], 'newname', 'EGI file epochs', 'epochinfo', 'yes');
%         % [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, CURRENTSET,'setname', 'EGI file epochs', 'save', setNamesegNx);
%         EEGO = pop_rmbase( EEGO, [0  8000]);
%         EEGO = pop_saveset( EEGO, NamSetSongOne, pathOut);
%         
...
%     try
%         disp('LittleJ')
%         EEGO = pop_epoch( EEG, { 'DLiJ' }, [0  8], 'newname', 'EGI file epochs', 'epochinfo', 'yes');
%         % [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, CURRENTSET,'setname', 'EGI file epochs', 'save', setNamesegNx);
%         EEGO = pop_rmbase( EEGO, [0  8000]);
%         EEGO = pop_saveset( EEGO, NamSetSongOne, pathOut);
%         
...
%     try
%         disp('Winter')
%         EEGO = pop_epoch( EEG, { 'DWin' }, [0  8], 'newname', 'EGI file epochs', 'epochinfo', 'yes');
%         % [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, CURRENTSET,'setname', 'EGI file epochs', 'save', setNamesegNx);
%         EEGO = pop_rmbase( EEGO, [0  8000]);
%         EEGO = pop_saveset( EEGO, NamSetSongOne, pathOut);
%         
...
%     try
%         disp('Ride')
%         EEGO = pop_epoch( EEG, { 'DRid' }, [0  8], 'newname', 'EGI file epochs', 'epochinfo', 'yes');
%         % [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, CURRENTSET,'setname', 'EGI file epochs', 'save', setNamesegNx);
%         EEGO = pop_rmbase( EEGO, [0  8000]);
%         EEGO = pop_saveset( EEGO, NamSetSongOne, pathOut);
%         
...
%     try
%         disp('TheQ')
%         EEGO = pop_epoch( EEG, { 'DThe' }, [0  8], 'newname', 'EGI file epochs', 'epochinfo', 'yes');
%         % [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, CURRENTSET,'setname', 'EGI file epochs', 'save', setNamesegNx);
%         EEGO = pop_rmbase( EEGO, [0  8000]);
%         EEGO = pop_saveset( EEGO, NamSetSongOne, pathOut);
%         
