...
pathOut='/media/Work/Data_RhythmProject/Data_Analysis/EEG_Analysis/2months/Event_Filtered_MarkedbyTrial_CleanByProb_RerefDetrendBase/';
...
for t =1:length(ssList)
    ...
    %pop_saveset(EEG,subjectName, '/media/sdb/Data_RhythmProject/Data_Analysis/EEG_Analysis/AutoReject_Trial/MarkedbyTrial/MeanEpoch/RerefDetrendRmBase/')
   
    %% Reject obviously bad trials
    % Reject by probability
   % [ALLEEG EEG CURRENTSET ALLCOM] = eeglab;
   % EEG = pop_loadset(subjectName,'/media/sdb/Data_RhythmProject/Data_Analysis/EEG_Analysis/Detrend/');
