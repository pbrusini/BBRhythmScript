function [LeftEye, RightEye, tempstimestamp, TrigSignal] = PlayVideoEEG_VisualOnly(moviename,Test, Grabber, shuf)
...
cmdDos_silent='vlc --fullscreen --video-on-top --no-video-title-show --noaudio --play-and-exit ';
    ...
    case {1,  2}
        for i=1:100
            ...
            if ~pause
                ...
                [status result]=system([cmdDos_silent moviename]);
                [lefteye, righteye, timestamp, trigSignal] = tetio_readGazeData;
                lefteye(:,14) = 77;
                righteye(:,14) = 77;
